...
function drawDebug(painter, tiles) {
    ...
    tiles.forEach(function(tile) {
        gl.switchShader(painter.debugShader);

        gl.uniformMatrix4fv(painter.debugShader.u_matrix, false, tile.posMatrix);
        gl.uniformMatrix4fv(painter.debugShader.u_exmatrix, false, tile.exMatrix);
        ...
        var coord = TileCoord.asString(tile.id);
